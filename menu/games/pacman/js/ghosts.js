		...
		if (canMoveGhost(ghost)) {
			...
			if (
				eval(
					"GHOST_" +
						ghost.toUpperCase() +
						"_BODY_STATE < GHOST_BODY_STATE_MAX"
				)
			) {
			...
			if (eval("GHOST_" + ghost.toUpperCase() + "_DIRECTION === 1")) {
				eval(
					"GHOST_" +
						ghost.toUpperCase() +
						"_POSITION_X += GHOST_POSITION_STEP;"
				);
			} else if (
				eval("GHOST_" + ghost.toUpperCase() + "_DIRECTION === 2")
			) {
				eval(
					"GHOST_" +
						ghost.toUpperCase() +
						"_POSITION_Y += GHOST_POSITION_STEP;"
				);
			} else if (
				eval("GHOST_" + ghost.toUpperCase() + "_DIRECTION === 3")
			) {
				eval(
					"GHOST_" +
						ghost.toUpperCase() +
				...
				eval("GHOST_" + ghost.toUpperCase() + "_DIRECTION === 4")
			) {
				eval(
					"GHOST_" +
						ghost.toUpperCase() +
			...
			eval(
				"GHOST_" + ghost.toUpperCase() + "_DIRECTION = oneDirection();"
			);
		}
	}
}
